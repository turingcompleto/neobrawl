                ...
                <div class="col-md-6">
                    ...
                    <div id="myTabContent" class="tab-content">
                        ...
                        <div class="tab-pane fade" id="reglas">
                            ...
                            <li>1 ganada y otra pérdida entonces una
                                batalla más para decidir al ganador. </li>
                           <li>Stock 2 Vidas. </li>
                           ...
                           <li>La eleccion del escenario queda por 
                               acuerdo por los combatientes. </li>
                               </ul>
                               </p>
                            <a href="#" class="btn btn-link">Ver más...</a>
                        </div>
               ...
               include('validacion1.php');
                ...
                <div class="col-md-5">
                    <form class="form-horizontal" action="index.php" method="post">
                        <fieldset>
                            <legend>Registro<h6 class="text-primary"><?php echo $mensaje ?></h6></legend>
